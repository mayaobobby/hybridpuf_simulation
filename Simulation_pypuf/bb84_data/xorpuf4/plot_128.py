...
if __name__ == '__main__':	
	...
	np.save('./c_xorpuf_n128k4_bb84_crps.npy', cpuf_crps)
	np.save('./c_xorpuf_n128k4_bb84_accuracy.npy', cpuf_accuracy_avg)
	np.save('./c_xorpuf_n128k4_bb84_succrate.npy', cpuf_suc_prob)

	np.save('./h_xorpuf_n128k4_bb84_crps.npy', hpuf_crps)
	np.save('./h_xorpuf_n128k4_bb84_accuracy.npy', hpuf_accuracy_avg)
	np.save('./h_xorpuf_n128k4_bb84_succrate.npy', hpuf_suc_prob)

	np.save('./hl_xorpuf_bit_n128k4_bb84_crps.npy', hlpuf_bit_crps)
	np.save('./hl_xorpuf_bit_n128k4_bb84_accuracy.npy', hlpuf_bit_accuracy_avg)
	np.save('./hl_xorpuf_bit_n128k4_bb84_succrate.npy', hlpuf_bit_suc_prob)

	np.save('./hl_xorpuf_basis_n128k4_bb84_crps.npy', hlpuf_basis_crps)
	np.save('./hl_xorpuf_basis_n128k4_bb84_accuracy.npy', hlpuf_basis_accuracy_avg)
