...
def accuracy_plot_64bits(cpuf_crps, cpuf_accuracy_avg, hpuf_crps, hpuf_accuracy_avg, hlpuf_bit_crps, hlpuf_basis_crps, hlpuf_bit_accuracy_avg, hlpuf_basis_accuracy_avg):
	...
	# 		cpuf_accuracy_avg[i+2:] = [None for x in cpuf_accuracy_avg[i+2:]]
	# 		break



	fig = plt.figure()
	plt.title('n=64, k=5',fontsize=15)
...
def feasrate_plot_64bits(cpuf_crps, cpuf_suc_prob, hpuf_crps, hpuf_suc_prob, hlpuf_bit_crps, hlpuf_basis_crps, hlpuf_bit_suc_prob, hlpuf_basis_suc_prob):
	for i in range(len(hlpuf_bit_crps)):
...
if __name__ == '__main__':	
	...
	cpuf_filename = "c_summary_xorpuf5_64.txt"
	hpuf_filename = "h_summary_xorpuf5_64.txt"
	hlpuf_filename = "hl_summary_xorpuf5_64.txt"
	...
	np.save('./c_xorpuf_n64k5_bb84_crps.npy', cpuf_crps)
	np.save('./c_xorpuf_n64k5_bb84_accuracy.npy', cpuf_accuracy_avg)
	np.save('./c_xorpuf_n64k5_bb84_succrate.npy', cpuf_suc_prob)

	np.save('./h_xorpuf_n64k5_bb84_crps.npy', hpuf_crps)
	np.save('./h_xorpuf_n64k5_bb84_accuracy.npy', hpuf_accuracy_avg)
	np.save('./h_xorpuf_n64k5_bb84_succrate.npy', hpuf_suc_prob)

	np.save('./hl_xorpuf_bit_n64k5_bb84_crps.npy', hlpuf_bit_crps)
	np.save('./hl_xorpuf_bit_n64k5_bb84_accuracy.npy', hlpuf_bit_accuracy_avg)
	np.save('./hl_xorpuf_bit_n64k5_bb84_succrate.npy', hlpuf_bit_suc_prob)

	np.save('./hl_xorpuf_basis_n64k5_bb84_crps.npy', hlpuf_basis_crps)
	np.save('./hl_xorpuf_basis_n64k5_bb84_accuracy.npy', hlpuf_basis_accuracy_avg)
	np.save('./hl_xorpuf_basis_n64k5_bb84_succrate.npy', hlpuf_basis_suc_prob)
	...
	feasrate_plot_64bits(cpuf_crps, cpuf_suc_prob, hpuf_crps, hpuf_suc_prob, hlpuf_bit_crps, hlpuf_basis_crps, hlpuf_bit_suc_prob, hlpuf_basis_suc_prob)
