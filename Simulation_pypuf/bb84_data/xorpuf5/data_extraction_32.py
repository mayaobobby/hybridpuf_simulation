...
def accuracy_plot_32bits(hlpuf_bit_crps, hlpuf_basis_crps, hlpuf_bit_accuracy_avg, hlpuf_basis_accuracy_avg):
...
def succrate_plot_32bits(cpuf_crps, cpuf_suc_prob, hpuf_crps, hpuf_suc_prob, hlpuf_bit_crps, hlpuf_basis_crps, hlpuf_bit_suc_prob, hlpuf_basis_suc_prob):
	for i in range(len(hlpuf_bit_crps)):
	...
	fig = plt.figure()
	plt.title('n=32, k=5',fontsize=15)
...
if __name__ == '__main__':	
	...
	hlpuf_filename = "hl_summary_xorpuf5_32.txt"
	...
	accuracy_plot_32bits(hlpuf_bit_crps, hlpuf_basis_crps, hlpuf_bit_accuracy_avg, hlpuf_basis_accuracy_avg)
	# succrate_plot_32bits(cpuf_crps, cpuf_suc_prob, hpuf_crps, hpuf_suc_prob, hlpuf_bit_crps, hlpuf_basis_crps, hlpuf_bit_suc_prob, hlpuf_basis_suc_prob)
