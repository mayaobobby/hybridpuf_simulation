...
'''
def bb84_xorpuf5(puf_bit, puf_basis, position, k, steps, success_prob, query_adaptive):
	...
	if position == 'basis':
		...
		np.save('./data/xorpuf5/'+str(n)+'n_xorpuf5_adaptive_crps.npy', crps*query_adaptive)
		np.save('./data/xorpuf5/'+str(n)+'h_xorpuf5_adaptive_'+position+'_a.npy', accuracy_hpuf)
...
if __name__ == '__main__':
	'''
	Simulation of HPUF with BB84 encoding and an underlying of 5XORPUF against adaptive adversaries
	...
	crps, accuracy_hpuf = bb84_xorpuf5(puf_bit, puf_basis, 'basis', k, steps, success_prob, query_adaptive)
