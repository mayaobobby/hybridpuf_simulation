...
'''
def bb84_xorpuf4(n, noisiness_cpuf, position, k, steps, success_prob):
...
if __name__ == '__main__':
	...
	crps_bit, accuracy_cpuf_bit, accuracy_hpuf_bit = bb84_xorpuf4(n, noisiness_cpuf, 'bit', k, steps, success_prob)
	_, _, accuracy_hpuf_basis = bb84_xorpuf4(n, noisiness_cpuf, 'basis', k, steps, success_prob)
